...
|---|---|---|---|---|---|
| 1 | [01-ASSETS.md](01-ASSETS.md) | SHOW ASSETS | `col-assets` | `asset` | Sigla one-shot. A mano fa take-over (ferma tutto tranne SFX, **chiude** anche i loop). |
...
| 4 | [04-MUSIC.md](04-MUSIC.md) | CANZONI DELL'EPISODIO | `col-music` | `music` | Non si concatena (show manuale), fadeOut 2 s, si abbassa sotto la voce, azzera i sottofondi. |
...
- **Gerarchia del mix (ducking)** — Voce/microfono in cima (abbassa tutti), poi musica/PRE-SHOW, poi asset/sottofondi. Il **livello** di ducking è globale: Impostazioni → *Riduzione ducking*. *(v1.15.15: rimosso il comportamento per-clip "stacco" — lo scopo lo determina la colonna; per uno stacchetto sopra la musica usare FX o VOCE, vedi [01-ASSETS.md](01-ASSETS.md) §4.)*
