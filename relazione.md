...
**Versione corrente**: 1.5.1 — Regole delle colonne (documentazione `docs/regole-colonne/`) + 3 correzioni: polifonia SFX, sottofondo in loop che si abbassa-e-rientra sotto jingle/canzoni (la sigla SHOW ASSET lo chiude), rimozione del campo `duckingRole` non funzionante · preceduta da v1.5.0 (Undo/Redo della playlist)  
