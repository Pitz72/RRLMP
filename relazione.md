...
**Versione corrente**: 1.5.0 — Undo/Redo della playlist (feature → bump MINORE) · preceduta da v1.4.14 (take-over asset/jingle/spot non-loop con FX e sottofondi in loop esenti, fix sottofondo in loop, export legato al .lmp, spostamento in blocco della multiselezione)  
