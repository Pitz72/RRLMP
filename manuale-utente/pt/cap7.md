...
O Runtime Live Machine utiliza um sistema de salvamento a vários níveis para garantir que os seus dados estejam sempre seguros.
...
O software monitoriza constantemente as suas ações. Se fez alterações não guardadas (carregou um clip, alterou um volume) e tentar fechar o programa, o RLM **bloqueará o encerramento** e mostrar-lhe-á um aviso: *"Existem alterações não guardadas"*.
...
Nem sempre nos lembramos de guardar. Por isso, o RLM inclui um sistema de **Auto-Backup** invisível que trabalha em segundo plano.
...
*   **Como recuperá-lo**:
    ...
    *   Renomeie-o retirando o .bak (ou abra-o diretamente com o RLM). Terá recuperado o trabalho até aos últimos 5 minutos.
...
### O Resultado
Obterá uma pasta contendo tudo o necessário. Pode ligar a pen USB a qualquer computador com o Runtime Live Machine instalado, abrir o ficheiro project.lmp e tudo funcionará perfeitamente, independentemente das letras de unidade ou dos caminhos originais.
