...
O Runtime Live Machine não é um simples leitor que toca ficheiros de áudio ao acaso. No seu interior existe um **"Cérebro" de Mistura** sempre ativo.
...
Não tem de se preocupar em baixar manualmente a música quando começa uma entrevista: o RLM trata disso.
...
Um erro clássico dos realizadores principiantes é fazer tocar uma música *sobre* uma base rítmica (Bed), criando um caos sonoro (bateria contra bateria). O RLM resolve este problema com a **Dominância Musical**.
