...
1.  **Regra de Ouro do MIDI**: O controlador deve estar ligado ao computador **ANTES** de iniciar o Runtime Live Machine Pro.
    *   Se o ligar com o software aberto, o navegador interno poderá não o ver. Feche e volte a abrir o RRLMP.
...
**P: Posso usar o RRLMP para automatizar a rádio 24h por dia?**
R: Não. O RRLMP foi concebido para a realização *Live* (programas assegurados por uma pessoa). Não tem funções de agendamento horário ou rotação musical automática infinita.
...
R: Não, o Runtime Live Machine Pro é um software de Desktop profissional para **Windows** e **macOS**. Requer a potência de gestão de ficheiros de um computador real.
