...
O Runtime Live Machine não utiliza menus complexos "Ficheiro > Importar". Foi concebido para trabalhar diretamente com as pastas do seu computador.
...
*   **Formatos Suportados**: Graças ao motor nativo, o RLM suporta quase todos os formatos de áudio padrão: **MP3, WAV, AAC (m4a), OGG, FLAC**.
...
> **Nota**: O software memoriza o "caminho" do ficheiro (ex. C:\Musica\Song.mp3). Se mover ou renomear o ficheiro original no seu computador, o RLM deixará de o conseguir encontrar (o cartão ficará vermelho/inativo). Para evitar este problema se mudar de PC, use a função "Export Package" (ver Cap. 7).
