...
Runtime Live Machine ist kein einfacher Player, der Audiodateien zufällig abspielt. In seinem Inneren befindet sich ein immer aktives **Misch-"Gehirn"**.
...
Sie müssen sich nicht darum kümmern, die Musik manuell leiser zu machen, wenn ein Interview beginnt: RLM kümmert sich darum.
...
Ein klassischer Fehler von Anfänger-Regisseuren ist es, einen Song *über* ein rhythmisches Bett zu spielen, was ein klangliches Chaos erzeugt (Schlagzeug gegen Schlagzeug). RLM löst dieses Problem mit der **Musik-Dominanz**.
