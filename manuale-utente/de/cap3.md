...
Runtime Live Machine verwendet keine komplexen "Datei > Importieren"-Menüs. Es ist so konzipiert, dass es direkt mit den Ordnern Ihres Computers arbeitet.
...
*   **Unterstützte Formate**: Dank der nativen Engine unterstützt RLM fast alle Standard-Audioformate: **MP3, WAV, AAC (m4a), OGG, FLAC**.
...
> **Hinweis**: Die Software speichert den "Pfad" der Datei (z. B. C:\Musik\Song.mp3). Wenn Sie die Originaldatei auf Ihrem Computer verschieben oder umbenennen, kann RLM sie nicht mehr finden (die Karte wird rot/inaktiv). Um dieses Problem beim Wechsel des PCs zu vermeiden, verwenden Sie die Funktion "Export Package" (siehe Kap. 7).
...
Während einer Show ändern sich die Bedürfnisse. RLM ermöglicht es Ihnen, das Raster spontan neu zu organisieren.
