...
Runtime Live Machine verwendet ein mehrstufiges Speichersystem, um sicherzustellen, dass Ihre Daten immer sicher sind.
...
Die Software überwacht ständig Ihre Aktionen. Wenn Sie ungespeicherte Änderungen vorgenommen haben (einen Clip geladen, eine Lautstärke geändert) und versuchen, das Programm zu schließen, **blockiert RLM das Schließen** und zeigt Ihnen eine Warnung an: *"Es gibt ungespeicherte Änderungen"*.
...
Man denkt nicht immer daran zu speichern. Aus diesem Grund enthält RLM ein unsichtbares **Auto-Backup**-System, das im Hintergrund arbeitet.
...
*   **Wie man es wiederherstellt**:
    ...
    *   Benennen Sie sie um, indem Sie das .bak entfernen (oder öffnen Sie sie direkt mit RLM). Sie haben die Arbeit bis zu den letzten 5 Minuten wiederhergestellt.
...
### Das Ergebnis
Sie erhalten einen Ordner, der alles Notwendige enthält. Sie können den USB-Stick an jeden Computer mit installierter Runtime Live Machine anschließen, die Datei project.lmp öffnen und alles wird perfekt funktionieren, unabhängig von Laufwerksbuchstaben oder Originalpfaden.
