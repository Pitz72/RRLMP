...
Runtime Live Machine utiliza un sistema de guardado de múltiples niveles para garantizar que sus datos estén siempre seguros.
...
El software monitorea constantemente sus acciones. Si ha realizado cambios no guardados (cargado un clip, cambiado un volumen) e intenta cerrar el programa, RLM **bloqueará el cierre** y le mostrará una advertencia: *"Hay cambios no guardados"*.
...
No siempre se acuerda uno de guardar. Por esto, RLM incluye un sistema de **Auto-Backup** invisible que trabaja en segundo plano.
...
*   **Cómo recuperarlo**:
    ...
    *   Renómbrelo quitando el .bak (o ábralo directamente con RLM). Habrá recuperado el trabajo hasta los últimos 5 minutos.
...
### El Resultado
Obtendrá una carpeta que contiene todo lo necesario. Puede conectar la memoria USB a cualquier computadora con Runtime Live Machine instalado, abrir el archivo project.lmp y todo funcionará perfectamente, independientemente de las letras de unidad o de las rutas originales.
