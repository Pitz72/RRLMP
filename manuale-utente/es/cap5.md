...
Runtime Live Machine Pro no es un simple reproductor que toca archivos de audio al azar. En su interior hay un **"Cerebro" de Mezcla** siempre activo.
...
No tiene que preocuparse por bajar manualmente la música cuando comienza una entrevista: RRLMP se encarga de ello.
...
Un error clásico de los directores novatos es hacer sonar una canción *sobre* una base rítmica (Bed), creando un caos sonoro (batería contra batería). RRLMP resuelve este problema con la **Dominancia Musical**.
