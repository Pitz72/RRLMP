...
1.  **Regla de Oro del MIDI**: El controlador debe estar conectado a la computadora **ANTES** de iniciar Runtime Live Machine.
    *   Si lo conecta con el software abierto, el navegador interno podría no verlo. Cierre y vuelva a abrir RLM.
...
**P: ¿Puedo usar RLM para automatizar la radio las 24 horas?**
R: No. RLM está diseñado para la dirección *En Vivo* (programas atendidos por una persona). No tiene funciones de programación horaria o rotación musical automática infinita.
...
R: No, Runtime Live Machine es un software de Escritorio profesional para **Windows** y **macOS**. Requiere la potencia de gestión de archivos de una computadora real.
