...
Por defecto, RLM sale por el dispositivo de audio predeterminado de Windows. Sin embargo, en un estudio (o con configuraciones de podcast avanzadas como el *Rødecaster Pro*), necesita separar los flujos.
...
> **Consejo para Rødecaster/Mezcladores USB**: Si su mezclador tiene múltiples canales USB (ej. Main y Sounds/Chat), configure RLM en un canal secundario (ej. "Sounds") para poder controlar su volumen con un fader dedicado en el mezclador físico, separándolo de los sonidos del sistema de Windows.

---

## 6.2 El Teclado (Teclas Rápidas)

El teclado de la computadora es el controlador más rápido que tiene. RLM incluye comandos globales preestablecidos y teclas personalizables.
...
### Conexión
1.  Conecte su controlador USB-MIDI a la computadora **antes** de iniciar Runtime Live Machine.
2.  Inicie el software. El motor MIDI reconocerá automáticamente el dispositivo.

### Modo MIDI Learn (Mapeo Fácil)
No necesita conocer códigos complicados. RLM aprende observando lo que hace.
