...
Runtime Live Machine n'est pas un simple lecteur qui joue des fichiers audio au hasard. À l'intérieur, il y a un **"Cerveau" de Mixage** toujours actif.
...
Vous n'avez pas à vous soucier de baisser manuellement la musique quand une interview commence : RLM s'en occupe.
...
Une erreur classique des réalisateurs débutants est de faire jouer une chanson *par-dessus* une base rythmique (Bed), créant un chaos sonore (batterie contre batterie). RLM résout ce problème avec la **Dominance Musicale**.
