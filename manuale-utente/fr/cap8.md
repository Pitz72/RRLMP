...
1.  **Règle d'Or du MIDI** : Le contrôleur doit être connecté à l'ordinateur **AVANT** de démarrer Runtime Live Machine Pro.
    *   Si vous le branchez alors que le logiciel est ouvert, le navigateur interne pourrait ne pas le voir. Fermez et rouvrez RRLMP.
...
**Q : Puis-je utiliser RRLMP pour automatiser la radio 24h/24 ?**
R : Non. RRLMP est conçu pour la régie *Live* (émissions assurées par une personne). Il n'a pas de fonctions de programmation horaire ou de rotation musicale automatique infinie.
...
R : Non, Runtime Live Machine Pro est un logiciel de Bureau professionnel pour **Windows** et **macOS**. Il nécessite la puissance de gestion de fichiers d'un véritable ordinateur.
